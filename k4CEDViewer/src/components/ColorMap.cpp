...
void ColorMap::jetColorMap(unsigned int* rgb, float value, float min, float max) {
  ...
  if (value == HUGE_VAL) {
    ...
    rgb[0] = 0;
    rgb[1] = 0;
    rgb[2] = c1 + (unsigned int)((255 - c1) * value / max4);
  } else if (value < 2 * max4) {
    rgb[0] = 0;
    rgb[1] = (unsigned int)(255 * (value - max4) / max4);
    rgb[2] = 255;
  } else if (value < 3 * max4) {
    rgb[0] = (unsigned int)(255 * (value - 2 * max4) / max4);
    rgb[1] = 255;
    rgb[2] = 255 - rgb[0];
  } else if (value < max) {
    rgb[0] = 255;
    rgb[1] = (unsigned int)(255 - 255 * (value - 3 * max4) / max4);
    rgb[2] = 0;
  } else {
    rgb[0] = 255;
    rgb[1] = rgb[2] = 0;
...
void ColorMap::hotColorMap(unsigned int* rgb, float value, float min, float max) {
  ...
  if (value == HUGE_VAL) {
    ...
    rgb[0] = (unsigned int)(255 * value / max3);
    rgb[1] = 0;
    rgb[2] = 0;
  } else if (value < 2 * max3) {
    rgb[0] = 255;
    rgb[1] = (unsigned int)(255 * (value - max3) / max3);
    rgb[2] = 0;
  } else if (value < max) {
    rgb[0] = 255;
    rgb[1] = 255;
    rgb[2] = (unsigned int)(255 * (value - 2 * max3) / max3);
  } else {
    rgb[0] = rgb[1] = rgb[2] = 255;
  }
}
...
void ColorMap::coldColorMap(unsigned int* rgb, float value, float min, float max) {
  ...
  if (value == HUGE_VAL) {
    ...
    rgb[0] = 0;
    rgb[1] = 0;
    rgb[2] = (unsigned int)(255 * value / max3);
  } else if (value < 2 * max3) {
    rgb[0] = 0;
    rgb[1] = (unsigned int)(255 * (value - max3) / max3);
    rgb[2] = 255;
  } else if (value < max) {
    rgb[0] = (unsigned int)(255 * (value - 2 * max3) / max3);
    rgb[1] = 255;
    rgb[2] = 255;
  } else {
    rgb[0] = rgb[1] = rgb[2] = 255;
...
void ColorMap::blueColorMap(unsigned int* rgb, float value, float min, float max) {
  ...
  if (value == HUGE_VAL) {
    ...
    rgb[0] = 0;
    rgb[1] = 0;
    rgb[2] = (unsigned int)(255 * value / max);
  } else {
    rgb[0] = rgb[1] = 0;
    rgb[2] = 255;
  }
...
void ColorMap::cyclicColorMap(unsigned int* rgb, float value, float min, float max) {
  ...
  if (value < max3) {
    rgb[0] = (unsigned int)(255 - 255 * value / max3);
    rgb[1] = 0;
    rgb[2] = 255 - rgb[0];
  } else if (value < 2 * max3) {
    rgb[0] = 0;
...
// taken from
// https://stackoverflow.com/questions/3018313/algorithm-to-convert-rgb-to-hsv-and-hsv-to-rgb-in-range-0-255-for-both#comment66194776_14733008
